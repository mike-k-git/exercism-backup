defmodule RationalNumbers do
  ...
  def add({a1, b1}, {a2, b2}) when b1 == b2, do: {a1 + a2, b1} |> reduce()
  ...
  def subtract({a1, b1}, {a2, b2}) when b1 == b2, do: {a1 - a2, b1} |> reduce()
  def subtract({a1, b1}, {a2, b2}), do: {a1 * b2 - b1 * a2, b1 * b2} |> reduce()
